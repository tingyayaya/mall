    ...
    function getItemContent(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.rs==100){
                    var item = data.row;
                    	$('#uid').val(item.skf2971);
	                    $('#username').val(item.skf2972);
	                    $('#phonenum').val(item.skf2974);
	                    $('#city').val(item.skf3964+','+item.skf3965+','+item.skf3966);
	                    $('#addresslast').val(item.skf2973);
	                    $('#value').val(item.skf3964+','+item.skf3965+','+item.skf3966);
                        $('#idcard').val(item.skf3839);
	                    if(item.skf2991==1){
	                        $('.aui-switch').prop('checked',true);
	                    }else{
	                        $('.aui-switch').prop('checked',false);
	                    }
                }
            }
        });
